# Generated by Powerlevel10k configuration wizard on 2023-02-02 at 10:09 EST.
...
() {
  ...
  function prompt_my_doppler_config() {
    local result=$(doppler --no-check-version configure --json | jq -r '.[] | {"enclave.project","enclave.config"}| join(".")') 2>/dev/null
